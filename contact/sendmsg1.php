...
//$to_admin="rakesh@svastera.com";
	...
	//$admin1="ramakrishna@svastera.com";
	//$admin2="sales@svastera.com";


$admin1="rakesh@svastera.com";
	$admin2="rakesh@svastera.com";




    mail($admin1, $subject, $message1, $headers);
    mail($admin2, $subject, $message1, $headers);
        ...
        <td style=\"text-align: left; font-weight: normal; vertical-align: top; margin: 0; padding: 0;\" align=\"center\" valign=\"top\"><center>
                <table style=\"width: 600px; border-collapse: collapse; border-spacing: 0; margin: auto; border: 0;\" border=\"0\" width=\"600\" cellspacing=\"0\" cellpadding=\"0\">
                    ...
                    <tr>
                        ...
                        <td style=\"text-align: right; font-weight: normal; vertical-align: middle; font-size: 12px; color: #323e47; margin: 0; padding: 0;\" align=\"right\" valign=\"middle\"><h3>Hello $fname $lname </h3> Thanks for Contacting Us<br>We will get back to you Shortly</a></td>
                    </tr>
                    <tr>
